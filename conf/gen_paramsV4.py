...
#gamma_dict["High"] = {}
gamma_dict["Cluster1"] = ([3.647050553020999, 1.3510048035396238])
gamma_dict["Cluster4"] = ([1.1985168616800277, 9.458702239382777])

#gamma_dict["Med"] = {}
gamma_dict["Cluster2"] = ([7.514915398270334, 0.6761573629929288])
gamma_dict["Cluster3"] = ([2.563442325389048, 3.0138089717129635])

#gamma_dict["Low"] = {}
gamma_dict["Cluster5"]  = ([3.8978050249519, 1.0226888139541022])

#pgaussian_dict = {}
pgaussian_dict["Cluster1"] = ([2.76875114, 2.85382056],[[1.45271406e-04, -3.36416997e-05],[ -3.36416997e-05, 1.92515130e-04]])
pgaussian_dict["Cluster4"] = ([1.42923284, 1.72062993],[[0.00094602, 0.0001773 ], [ 0.0001773, 0.00078666]])

#pgaussian_dict = {}
pgaussian_dict["Cluster2"]  = ([3.15076423,3.00486636],[[1.41064331e-04,  -2.32959192e-0],[ -2.32959192e-05,  1.29842141e-04]])
pgaussian_dict["Cluster3"]  = ([3.65220284, 3.91066074], [[1.44527265e-04, -4.36093796e-05],[ -4.36093796e-05,  1.57100483e-04]])

#pgaussian_dict = {}
pgaussian_dict["Cluster5"]  = ([3.21069598, 4.04306316],[[2.96013342e-04,  -2.41472590e-0 ], [ -2.41472590e-05,   1.86607416e-04]])
